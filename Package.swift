...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/pxlshpr/PrepCoreDataStack", from: "0.0.32"),
        ...
        .package(url: "https://github.com/pxlshpr/PrepDataTypes", from: "0.0.284"),
        .package(url: "https://github.com/pxlshpr/PrepNetworkController", from: "0.0.22"),
        .package(url: "https://github.com/pxlshpr/PrepViews", from: "0.0.148"),
        ...
        .package(url: "https://github.com/pxlshpr/SwiftUISugar", from: "0.0.371"),
