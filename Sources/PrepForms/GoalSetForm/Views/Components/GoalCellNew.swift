...
//        guard goal.hasOneBoundOnly else { return false }
...
//        var texts: some View {
//            if goal.isAutoGenerated {
//                cprint("   goal bounds are: \(goal.lowerBound), \(goal.upperBound)")
//                cprint("   texts using: \(lowerBound), \(upperBound)")
//            }
//            return HStack {
//                if let lowerBound {
//                    if upperBound == nil {
