...
class SizeFormModel_Legacy: ObservableObject {
...
//    @Published var showingAmountForm = false
    ...
    func updateFormState(of sizeModel: Field, comparedToExisting existingSizeModel: Field? = nil) {
        let newFormState = sizeModel.formState(existingFieldModel: existingSizeModel)
