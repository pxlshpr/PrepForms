...
extension UnitPicker_Legacy {
    ...
    var shouldShowAddSizeButton: Bool {
        allowAddSize && fields.allSizes.isEmpty
    }
    ...
    var standardSizeContents: some View {
        ForEach(fields.standardSizes, id: \.self) { sizeField in
            sizeButton(for: sizeField)
        }
    }
    
    @ViewBuilder
    func sizeButton(for sizeField: Field) -> some View {
        if let size = sizeField.size {
            Button {
    ...
    var volumePrefixedSizeContents: some View {
        ForEach(fields.volumePrefixedSizes, id: \.self) { sizeField in
            volumePrefixedSizeGroup(for: sizeField)
        }
    }
    
    @ViewBuilder
    func volumePrefixedSizeGroup(for sizeField: Field) -> some View {
        if let size = sizeField.size {
