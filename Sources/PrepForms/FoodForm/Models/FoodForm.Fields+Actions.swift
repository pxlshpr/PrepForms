...
//        guard servingModel.fieldValue.doubleValue.unit.isServingBased, case .size(let size, _) = servingModel.fieldValue.doubleValue.unit else {
//            return
//        }
//        let newAmount: Double
//        if let quantity = size.quantity, let servingAmount = servingModel.fieldValue.doubleValue.double, servingAmount > 0 {
