...
//
//@MainActor
//public class LabelScannerModel: ObservableObject {
//
//    var isCamera: Bool
...
//        cprint("LabelScannerModel: 🚠 scrollViewDidEndZooming — offset: \(contentOffset) size: \(contentSize)")
//        
