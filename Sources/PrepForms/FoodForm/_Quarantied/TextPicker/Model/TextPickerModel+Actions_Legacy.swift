...
////        FoodFormModel.shared.processScanResults(
...
//    
//    func tappedAutoFill() {
//        guard let scanResult = imageModels[currentIndex].scanResult,
...
//        guard let singleSelectedImageText, singleSelectedImageText.imageId == imageModels[index].id else {
//            return nil
//        }
//        
...
////            for i in 0..<self.imageModels.count {
////                guard i != index,
...
//        withAnimation {
//            let _ = imageModels.remove(at: currentIndex)
